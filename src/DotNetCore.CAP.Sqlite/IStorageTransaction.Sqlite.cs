...
{
    public class SqliteStorageTransaction : IStorageTransaction
    {
        private readonly IDbConnection _dbConnection;

        private readonly string _prefix;

        public SqliteStorageTransaction(SqliteStorageConnection connection)
        {
            var options = connection.Options;
            _prefix = options.TableNamePrefix;

            _dbConnection = new SqliteConnection(options.ConnectionString);
        }
